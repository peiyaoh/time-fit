...
const config = {
  ...
  // Next.js page files happen to be named test.js (e.g. contrib/legacy/fitbit-break/pages/test.js,
  ...
  testPathIgnorePatterns: [
    '/node_modules/',
    '<rootDir>/contrib/legacy/fitbit-break/pages/',
    '<rootDir>/contrib/legacy/fitbit-break/.next/',
  ],
  globals: {
    'ts-jest': {
      useESM: true,
